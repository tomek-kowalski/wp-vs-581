...
if( $firmy->have_posts() ): ?>
	...
	<?php while( $firmy->have_posts() ) : $firmy->the_post(); wp_reset_query();	 // Restore global post data stomped by the_post(). ?>
...
<?php
echo do_shortcode('[link_on_backend]');   
?>

...
<h5 class="mb-0">Katalog firm, szkoleń i kursów, technologii i rozwiązań</h5>
</div>
</section>
...
<div class="button_grp">
				<ul>
					...
					<li data-li="lang" class="btn">Szkolenia i kursy</li>
					<li data-li="course" class="btn">Pluginy Wordpress</li>
					<li data-li="software" class="btn">Pluginy Woocommerce</li>
				</ul>
			</div>
			...
			<div class="item_grp btn-group" data-toggle="buttons">
				...
				<div class="item lang">
					<div class="icon_wrp">
					<?php $category_link = get_category_link( 36, 'szkolenia_it' ); ?>
			    ...
			    <?php $category_link_14w = get_category_link( 94 ); ?>
						<button onclick="location.href='<?php echo $category_link_14w; ?>'" class="icon-word button" data-li="course" data-toggle="tooltip" data-placement="top" title="Pluginy Wordpress">BEZPIECZEŃSTWO</button>
					</div>
				</div>
				...
				<div class="item-word software">
					...
					<?php $category_link_3woo = get_category_link( 109 ); ?>
						<button onclick="location.href='<?php echo $category_link_3woo; ?>'" class="icon-woo button" data-li="software" data-toggle="tooltip" data-placement="top" title="Pluginy Woocommerce">LOGISTYKA</button>
					</div>
				</div>
...
$query4 = new WP_Query( $args1 );
		...
		if ( $query4->have_posts() ) :
			...
			while ( $query4->have_posts() ) :
				 ...
				 */
				get_template_part( 'template-parts/content', 'firmy_programy' );
